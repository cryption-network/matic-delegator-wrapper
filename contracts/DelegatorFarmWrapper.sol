...
contract DelegatorFarmWrapper {
     ...
     */
    function init (IERC20 _rewardToken, uint256 _amount, IERC20 _lpToken, IStakeManager _validatorShare, uint256 _blockReward, uint256 _startBlock, uint256 _endBlock, uint256 _bonusEndBlock, uint256 _bonus) public {
        ...
        validatorShare = _validatorShare; // TODO: only farmGenerator can update validatorShare address.
    }
    ...
    function pendingMaticRewards(address user) external view returns (uint256) {
    ...
    function deposit(uint256 _amount) public {
        ...
        farmInfo.lpToken.safeApprove(address(this), validatorShare, _amount);
        ...
        farmInfo.lpToken.safeApprove(address(this), validatorShare, 0);
